...
%%%%% DEFINICAO DE PARAMETROS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for ss = 1:nsess_total
        ...
        arquivo = ['smr_training_session_' IDSessao '_leftHand_subject_' sujeito '_20161031_lrh.mat'];
        load(arquivo);
        ...
        arquivo = ['smr_training_session_' IDSessao '_rightHand_subject_' sujeito '_20161031_lrh.mat'];
        load(arquivo);
        ...
        for j = 1:8                                                                % da primeira ate a ultima janela
            ...
            for e = 1:length(num_eletr_orig)                                       % para cada um dos eletrodos, cria-se um elemento do vetor de atributos da janela atual
                ...
                janela_dir = dados_esq(e,inicio:fim);
